      ...
      <ScrollView>
        ...
        <Modal transparent={true} animationType="slide" visible={modalVisiblepupusas} onRequestClose={() => {
          ...
          <View style={styles.vistaModal}>
            <View style={styles.Modal}>
              ...
              <Text>El Salvador cuenta con uno de los mejores platillos de Centroamérica.</Text>
        ...
        <Modal transparent={true} animationType="slide" visible={modalVisiblerutas} onRequestClose={() => {
          ...
          <View style={styles.vistaModal}>
            <View style={styles.Modal}>
              <Text style={styles.subtitulo}>Comer Pupusas</Text>
              <Text>El Salvador cuenta con uno de los mejores destinos turisticos de Centroamérica.</Text>
